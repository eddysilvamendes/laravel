...
Route::group(['namespace' => 'Api\V1'], function () {
        ...
        //  Route::get('natural_drinks', 'ProductController@get_natural_drinks');
        Route::get('categories', 'CategoriesController@get_categories');
        Route::get('list', 'ProductController@get_products_list');
    }); 
